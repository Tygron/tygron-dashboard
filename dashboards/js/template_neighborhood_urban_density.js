...
$(window).on("load", function() {
	...
	queryDataManager.addQuery('landsize_current'  , '$SELECT_LANDSIZE_WHERE_NEIGHBORHOOD_IS_ID_AND_MAP_IS_CURRENT');
	queryDataManager.addQuery('landsize_maquette'  , '$SELECT_LANDSIZE_WHERE_NEIGHBORHOOD_IS_ID_AND_MAP_IS_MAQUETTE');

	queryDataManager.addQuery('lotsize_current'  , '$SELECT_LOTSIZE_WHERE_NEIGHBORHOOD_IS_ID_AND_ATTRIBUTE_MULT_IS_SOLID_AND_MAP_IS_CURRENT');
	queryDataManager.addQuery('lotsize_maquette'  , '$SELECT_LOTSIZE_WHERE_NEIGHBORHOOD_IS_ID_AND_ATTRIBUTE_MULT_IS_SOLID_AND_MAP_IS_MAQUETTE');
	
	queryDataManager.addQuery('floorsize_current'  , '$SELECT_FLOORSIZE_WHERE_NEIGHBORHOOD_IS_ID_AND_ATTRIBUTE_MULT_IS_SOLID_AND_MAP_IS_CURRENT');
	queryDataManager.addQuery('floorsize_maquette'  , '$SELECT_FLOORSIZE_WHERE_NEIGHBORHOOD_IS_ID_AND_ATTRIBUTE_MULT_IS_SOLID_AND_MAP_IS_MAQUETTE');

	queryDataManager.addQuery('units_current'  , '$SELECT_UNITS_WHERE_NEIGHBORHOOD_IS_ID_AND_ATTRIBUTE_MULT_IS_SOLID_AND_MAP_IS_CURRENT');
	queryDataManager.addQuery('units_maquette'  , '$SELECT_UNITS_WHERE_NEIGHBORHOOD_IS_ID_AND_ATTRIBUTE_MULT_IS_SOLID_AND_MAP_IS_MAQUETTE');
