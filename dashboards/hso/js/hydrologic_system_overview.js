...
function createWeirs() {
	...
	let width = queries.getDataMatrix(WEIR_WIDTH, true);
	let heights = queries.getDataMatrix(WEIR_HEIGHT_OUTPUT, true);
	let flow = queries.getDataMatrix(WEIR_FLOW_OUTPUT, true);
	let datumA = queries.getDataMatrix(WEIR_DATUM_OUTPUT_A, true);
	let datumB = queries.getDataMatrix(WEIR_DATUM_OUTPUT_B, true);
	let damWidth = queries.getDataMatrix(WEIR_DAM_WIDTH, true);
	let damHeight = queries.getDataMatrix(WEIR_DAM_HEIGHT, true);
	let areaOutputA = queries.getDataMatrix(WEIR_AREA_OUTPUT_A, true);
	let areaOutputB = queries.getDataMatrix(WEIR_AREA_OUTPUT_B, true);
	let angle = queries.getDataMatrix(WEIR_ANGLE, true);
	let coefficient = queries.getDataMatrix(WEIR_COEFFICIENT, true);
	let weirN = queries.getDataMatrix(WEIR_N, true);
...
function createCulverts() {
	...
	let diameters = queries.getDataMatrix(CULVERT_DIAMETER, true);
	let datumHeights = queries.getDataMatrix(CULVERT_DATUM_HEIGHT, true);
	let rectangularHeights = queries.getDataMatrix(CULVERT_RECTANGULAR_HEIGHT, true);
	let culvertNs = queries.getDataMatrix(CULVERT_N, true);
	let heights = queries.getDataMatrix(CULVERT_HEIGHT_OUTPUT, true);
	let flows = queries.getDataMatrix(CULVERT_FLOW_OUTPUT, true);
	let datumsA = queries.getDataMatrix(CULVERT_DATUM_OUTPUT_A, true);
	let datumsB = queries.getDataMatrix(CULVERT_DATUM_OUTPUT_B, true);
	let areaIDA = queries.getDataMatrix(CULVERT_AREA_OUTPUT_A, true);
	let areaIDB = queries.getDataMatrix(CULVERT_AREA_OUTPUT_B, true);
	let elevationA = queries.getDataMatrix(CULVERT_DATUM_HEIGHT_OUTPUT_A, true);
	let elevationB = queries.getDataMatrix(CULVERT_DATUM_HEIGHT_OUTPUT_B, true);
