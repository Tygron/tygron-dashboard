...
function createWeirs() {
	...
	let width = queries.getMatrixData(WEIR_WIDTH, true);
	let heights = queries.getMatrixData(WEIR_HEIGHT_OUTPUT, true);
	let flow = queries.getMatrixData(WEIR_FLOW_OUTPUT, true);
	let datumA = queries.getMatrixData(WEIR_DATUM_OUTPUT_A, true);
	let datumB = queries.getMatrixData(WEIR_DATUM_OUTPUT_B, true);
	let damWidth = queries.getMatrixData(WEIR_DAM_WIDTH, true);
	let damHeight = queries.getMatrixData(WEIR_DAM_HEIGHT, true);
	let areaOutputA = queries.getMatrixData(WEIR_AREA_OUTPUT_A, true);
	let areaOutputB = queries.getMatrixData(WEIR_AREA_OUTPUT_B, true);
	let angle = queries.getMatrixData(WEIR_ANGLE, true);
	let coefficient = queries.getMatrixData(WEIR_COEFFICIENT, true);
	let weirN = queries.getMatrixData(WEIR_N, true);
...
function createCulverts() {
	...
	let diameters = queries.getMatrixData(CULVERT_DIAMETER, true);
	let datumHeights = queries.getMatrixData(CULVERT_DATUM_HEIGHT, true);
	let rectangularHeights = queries.getMatrixData(CULVERT_RECTANGULAR_HEIGHT, true);
	let culvertNs = queries.getMatrixData(CULVERT_N, true);
	let heights = queries.getMatrixData(CULVERT_HEIGHT_OUTPUT, true);
	let flows = queries.getMatrixData(CULVERT_FLOW_OUTPUT, true);
	let datumsA = queries.getMatrixData(CULVERT_DATUM_OUTPUT_A, true);
	let datumsB = queries.getMatrixData(CULVERT_DATUM_OUTPUT_B, true);
	let areaIDA = queries.getMatrixData(CULVERT_AREA_OUTPUT_A, true);
	let areaIDB = queries.getMatrixData(CULVERT_AREA_OUTPUT_B, true);
	let elevationA = queries.getMatrixData(CULVERT_DATUM_HEIGHT_OUTPUT_A, true);
	let elevationB = queries.getMatrixData(CULVERT_DATUM_HEIGHT_OUTPUT_B, true);
