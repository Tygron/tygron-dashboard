...
queries.addQuery(M3TOTAL, 
	'$SELECT_GRIDVOLUME_WHERE_GRID_WITH_ATTRIBUTE_IS_HSO_WATER_OVERLAY_AND_RESULTTYPE_IS_SURFACE_LAST_VALUE_AND_GRID_WITH_ATTRIBUTE_IS_HSO_WATER_OVERLAY_AND_TIMEFRAME_IS_X_AND_AREA_IS_ID');
queries.addQuery(M3WATER, 
	'$SELECT_GRIDVOLUME_WHERE_GRID_WITH_ATTRIBUTE_IS_HSO_WATER_OVERLAY_AND_GRID_WITH_ATTRIBUTE_IS_HSO_M3WATER_AND_TIMEFRAME_IS_X_AND_AREA_IS_ID');
queries.addQuery(M3GROUND, 
	'$SELECT_GRIDVOLUME_WHERE_GRID_WITH_ATTRIBUTE_IS_HSO_WATER_OVERLAY_AND_RESULTTYPE_IS_GROUND_LAST_STORAGE_AND_TIMEFRAME_IS_X_AND_AREA_IS_ID');
queries.addQuery(M3STORAGE, 
	'$SELECT_GRIDVOLUME_WHERE_GRID_WITH_ATTRIBUTE_IS_HSO_WATER_OVERLAY_AND_RESULTTYPE_IS_BUILDING_LAST_STORAGE_AND_TIMEFRAME_IS_X_AND_AREA_IS_ID');
queries.addQuery(M3SEWER, 
	'$SELECT_GRIDVOLUME_WHERE_GRID_WITH_ATTRIBUTE_IS_HSO_WATER_OVERLAY_AND_RESULTTYPE_IS_SEWER_LAST_VALUE_AND_TIMEFRAME_IS_X_AND_AREA_IS_ID');
queries.addQuery(M3UNSATURATED, 
	'$SELECT_GRIDVOLUME_WHERE_GRID_WITH_ATTRIBUTE_IS_HSO_WATER_OVERLAY_AND_RESULTTYPE_IS_GROUND_LAST_UNSATURATED_STORAGE_AND_TIMEFRAME_IS_X_AND_AREA_IS_ID');
...
queries.addQuery(CULVERT_AREA_FROM, 
	'$SELECT_ATTRIBUTE_WHERE_GRID_WITH_ATTRIBUTE_IS_HSO_WATER_OVERLAY_AND_KEY_IS_OBJECT_WATER_AREA_OUTPUT_AND_BUILDING_IS_XK_CULVERT_DIAMETER_AND_INDEX_IS_0');
queries.addQuery(CULVERT_AREA_TO, 
	'$SELECT_ATTRIBUTE_WHERE_GRID_WITH_ATTRIBUTE_IS_HSO_WATER_OVERLAY_AND_KEY_IS_OBJECT_WATER_AREA_OUTPUT_AND_BUILDING_IS_XK_CULVERT_DIAMETER_AND_INDEX_IS_1');
queries.addQuery(PUMP_AREA_FROM, 
	'$SELECT_ATTRIBUTE_WHERE_GRID_WITH_ATTRIBUTE_IS_HSO_WATER_OVERLAY_AND_KEY_IS_OBJECT_WATER_AREA_OUTPUT_AND_BUILDING_IS_XK_PUMP_Q_AND_INDEX_IS_0');
queries.addQuery(PUMP_AREA_TO, 
	'$SELECT_ATTRIBUTE_WHERE_GRID_WITH_ATTRIBUTE_IS_HSO_WATER_OVERLAY_AND_KEY_IS_OBJECT_WATER_AREA_OUTPUT_AND_BUILDING_IS_XK_PUMP_Q_AND_INDEX_IS_1');
queries.addQuery(INLET_AREA_FROM, 
	'$SELECT_ATTRIBUTE_WHERE_GRID_WITH_ATTRIBUTE_IS_HSO_WATER_OVERLAY_AND_KEY_IS_OBJECT_WATER_AREA_OUTPUT_AND_BUILDING_IS_XK_INLET_Q_AND_INDEX_IS_0');
queries.addQuery(INLET_AREA_TO, 
	'$SELECT_ATTRIBUTE_WHERE_GRID_WITH_ATTRIBUTE_IS_HSO_WATER_OVERLAY_AND_KEY_IS_OBJECT_WATER_AREA_OUTPUT_AND_BUILDING_IS_XK_INLET_Q_AND_INDEX_IS_1');
queries.addQuery(WEIR_AREA_FROM, 
	'$SELECT_ATTRIBUTE_WHERE_GRID_WITH_ATTRIBUTE_IS_HSO_WATER_OVERLAY_AND_KEY_IS_OBJECT_WATER_AREA_OUTPUT_AND_BUILDING_IS_XK_WEIR_HEIGHT_AND_INDEX_IS_0');
queries.addQuery(WEIR_AREA_TO, 
	'$SELECT_ATTRIBUTE_WHERE_GRID_WITH_ATTRIBUTE_IS_HSO_WATER_OVERLAY_AND_KEY_IS_OBJECT_WATER_AREA_OUTPUT_AND_BUILDING_IS_XK_WEIR_HEIGHT_AND_INDEX_IS_1');
queries.addQuery(BREACH_AREA_FROM, 
	'$SELECT_ATTRIBUTE_WHERE_GRID_WITH_ATTRIBUTE_IS_HSO_WATER_OVERLAY_AND_KEY_IS_OBJECT_WATER_AREA_OUTPUT_AND_AREA_IS_XK_BREACH_HEIGHT_AND_INDEX_IS_0');
queries.addQuery(BREACH_AREA_TO, 
	'$SELECT_ATTRIBUTE_WHERE_GRID_WITH_ATTRIBUTE_IS_HSO_WATER_OVERLAY_AND_KEY_IS_OBJECT_WATER_AREA_OUTPUT_AND_AREA_IS_XK_BREACH_HEIGHT_AND_INDEX_IS_1');
queries.addQuery(INLET_UNDERGROUND, 
	'$SELECT_ATTRIBUTE_WHERE_GRID_WITH_ATTRIBUTE_IS_HSO_WATER_OVERLAY_AND_KEY_IS_UNDERGROUND_AND_BUILDING_IS_XK_INLET_Q_AND_INDEX_IS_0');
...
queries.addQuery(RAINM3STORAGE,
	'$SELECT_GRIDVOLUME_WHERE_GRID_WITH_ATTRIBUTE_IS_HSO_WATER_OVERLAY_AND_TIMEFRAME_IS_X_AND_AREA_IS_ID_AND_RESULTTYPE_IS_BUILDING_LAST_STORAGE_AND_TIMEFRAME_IS_X_AND_AREA_IS_ID');
