...
flowTitles[INFILTRATIONM3] = 'Infiltratie [m³/tijdstap]';
flowTitles[EVAPORATIONM3] = 'Verdamping [m³/tijdstap]';
flowTitles[SEWER_IN] = 'POCRiool [m³/tijdstap]';
flowTitles[SEWER_OVERFLOW] = 'Riooloverstort [m³/tijdstap]';
...
flowTitles[MODEL_IN] = "Model in [m³/tijdstap]";
flowTitles[MODEL_OUT] = "Model uit [m³/tijdstap]";
flowTitles[M3GROUND] = "Bodem [m³/tijdstap]";
flowTitles[M3LAND] = "Maaiveld [m³/tijdstap]";
flowTitles[M3WATER] = "Oppervlaktewater [m³/tijdstap]";
