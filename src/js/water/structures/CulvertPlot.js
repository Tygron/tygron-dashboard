...
export function drawCulvertSide(canvas, index, culvertDatums, datumsLeft, datumsRight, culvertDiameter, culvertRectangleHeight, elevationLeft, elevationRight) {
	...
	let terrainLeftTop = canvas.height-(elevationLeft - Math.min(elevationLeft, elevationRight) + baseHeight);
	let terrainRightTop = canvas.height-(elevationRight - Math.min(elevationLeft, elevationRight) + baseHeight);
